  ...
  return (
    ...
    {videoUrl ? (
      ...
      <div
              ...
              className="text-[#767676] hover:text-primeColor md:text-sm text-xl font-normal border-b-[1px] border-b-gray-200 hover:border-b-primeColor flex items-center justify-sart gap-2 hover:cursor-pointer pb-1 duration-300 w-fit "
            >
