...
const ProductBanner = ({ itemsPerPageFromBanner, viewMode, setViewMode }) => {
  const [gridViewActive, setGridViewActive] = useState(viewMode === "grid");
  const [listViewActive, setListViewActive] = useState(viewMode === "list");
  ...
  } ); // Include setViewMode in the dependency array
